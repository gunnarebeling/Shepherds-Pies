        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Employees_DeliveryEmployeeId",
                        column: x => x.DeliveryEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Employees_OrderEmployeeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "John", "a4b9c99e-87ab-4c5a-9d53-1e3f5248a1b0", "Doe" }
                });
            ...
            migrationBuilder.InsertData(
                table: "PizzaTopping",
                columns: new[] { "PizzasId", "ToppingsId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 1, 2 },
